...
#NEED TO CHECK IF THIS IS FOR THE CUDA OPENCV INSTALL OR NOT
...
sudo apt install -y libv41-dev libxvidcore-dev libx264-dev unzip
...
echo_red "installing openCV, this may take a while"
